...
import br.com.zup.rmendes.grpc.KeymanagerRegistraGrpcServiceGrpc
import br.com.zup.rmendes.grpc.RegistraChavePixRequest
import br.com.zup.rmendes.grpc.TipoDeChave
import br.com.zup.rmendes.grpc.TipoDeConta
import br.com.zup.rmendes.integration.bcb.*
import br.com.zup.rmendes.integration.itau.ContasDeClientesNoItauClient
import br.com.zup.rmendes.integration.itau.DadosDaContaResponse
import br.com.zup.rmendes.integration.itau.InstituicaoResponse
import br.com.zup.rmendes.integration.itau.TitularResponse
...
import br.com.zup.rmendes.util.violations
...
internal class RegistraChaveEndpointTest(
    ...
    fun `nao deve registrar chave pix quando chave existente`() {
        ...
        repository.save(chave(
            tipo = br.com.zup.rmendes.pix.TipoDeChave.CPF,
            chave = "63657520325",
    ...
    private fun chave(
        tipo: br.com.zup.rmendes.pix.TipoDeChave,
        ...
        return ChavePix(
            ...
            tipo = tipo,
            chave = chave,
            tipoDeConta = br.com.zup.rmendes.pix.TipoDeConta.CONTA_CORRENTE,
